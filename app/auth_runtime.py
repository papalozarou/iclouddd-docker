...
def attempt_auth(
    ...
    if IS_SUCCESS:
        ...
        if not WAS_SAVED:
            ...
            return AuthAttemptResult(
                auth_state=EFFECTIVE_STATE,
                is_authenticated=False,
                reason_code="state_save_failed_after_success",
    ...
    if "Two-factor code is required" in DETAILS:
        ...
        if not WAS_SAVED:
            ...
            return AuthAttemptResult(
                auth_state=EFFECTIVE_STATE,
                is_authenticated=False,
                reason_code="state_save_failed_after_mfa_required",
                operator_detail=DETAILS,
            )
    ...
    if not WAS_SAVED:
        ...
        return AuthAttemptResult(
            auth_state=EFFECTIVE_STATE,
            is_authenticated=False,
            reason_code="state_save_failed_after_auth_failed",
            operator_detail=DETAILS,
        )
